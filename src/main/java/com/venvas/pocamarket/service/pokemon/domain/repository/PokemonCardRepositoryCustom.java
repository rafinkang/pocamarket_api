...
public interface PokemonCardRepositoryCustom {
    ...
    Page<PokemonCardListDto> searchFilterList(PokemonCardListFormDto condition, Pageable pageable);
    // list 데이터를 Slice 객체로 리턴
    Slice<PokemonCardListDto> searchFilterSliceList(PokemonCardListFormDto condition, Pageable pageable);
