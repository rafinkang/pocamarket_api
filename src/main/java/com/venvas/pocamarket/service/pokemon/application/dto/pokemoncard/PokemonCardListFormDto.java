...
import com.venvas.pocamarket.service.pokemon.api.validator.PokemonStrArrParam;
...
public class PokemonCardListFormDto {
    ...
    @Size(max = 80, message = "속성은 80자를 초과할 수 없습니다.")
    @PokemonStrArrParam(expectedPokemonListPath = "com.venvas.pocamarket.service.pokemon.domain.value.CardElement", message = "유효하지 않은 속성입니다.")
//    @Pattern(regexp = "^(?i)(grass|fire|water|lightning|psychic|fighting|darkness|metal|dragon|normal|colorless)$", message = "유효하지 않은 속성입니다.")
    ...
    @PokemonStrArrParam(expectedPokemonListPath = "com.venvas.pocamarket.service.pokemon.domain.value.CardRarity", message = "유효하지 않은 레어도입니다.")
