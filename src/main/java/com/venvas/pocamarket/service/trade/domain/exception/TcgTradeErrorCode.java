...
public enum TcgTradeErrorCode {
    ...
    TRADE_REQUEST_ALREADY_COMPLETED("TCG_TRADE_107", "이미 완료된 교환 요청은 수정할 수 없습니다."),
    INVALID_TRADE_STATUS("TCG_TRADE_108", "변경될 교환의 상태 값이 유효하지 않습니다."),
    TRADE_REQUEST_NOT_EDITABLE("TCG_TRADE_109", "교환 요청을 수정할 수 없는 상태입니다."),
    TRADE_ALREADY_IN_PROGRESS("TCG_TRADE_110", "다른 요청글과 교환 진행 또는 완료 됐습니다."),
